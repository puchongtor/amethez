...
| อาจารย์เมธา | หมอดูที่ปรึกษา · ดวงชะตา / หินมงคล | สุขุม มั่นใจ ให้กำลังใจ · ดวงเป็นส่วนหนึ่ง ชีวิตดีต้องใช้กาย+ใจ | Line OA + สายมู aff |
| เมษา | Amethez Shorts — คลิป→บทความสั้น / ทริปหิน | น่ารัก สนุก ชอบพูด รักหิน | Shopee Aff + ดึงเข้าเว็บจากคลิป |
...
**Phase 1 ทำก่อน:** Crystal Atlas + Master Wuchong + อาจารย์เมธา + เมษา (Shorts)
**Phase 2 ทีหลัง:** Gemma + Max + Zin

### เมษา คือใคร (2026-08-08)
...
### อาจารย์เมธา คือใคร (ปรับ 2026-08-08)
**หมอดูที่ปรึกษาดวงชะตา** — ชายวัย ~40 มีญาณ สุขุม พูดมั่นใจ ชอบให้กำลังใจผ่านดวง เชื่อว่าดวงเป็นส่วนหนึ่ง แต่ชีวิตที่ดีต้องใช้พลังกายและพลังใจ — รายละเอียด + prompt หน้า ใน `METHA_BRIEF.md`
