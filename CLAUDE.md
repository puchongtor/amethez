...
| Master Wuchong | ปรัชญาหิน · บทเรียนชีวิตจากธรรมชาติ | ลึกซึ้ง ชวนคิด มีอารมณ์ขันเล็กน้อย | คอร์สเรียน + E-book |
| อาจารย์วัน | หมอดูพลังงานบวก & สายมู | สุขุม อบอุ่น ให้กำลังใจ · ไม่ขู่ดวงตก | Line OA + สายมู aff |
| น้องเมษา | คลิปสั้น เล่าเรื่องหิน (Shorts) | น่ารัก สนุก ชอบพูด รักหิน | Shopee Aff + ดึงเข้าเว็บจากคลิป |
...
**Phase 1 ทำก่อน:** Crystal Atlas + ปรัชญาหิน Wuchong + อาจารย์วัน + น้องเมษา (Shorts)
**Phase 2 ทีหลัง:** Gemma + Max + Zin

### น้องเมษา คือใคร (2026-08-08)
"บรรณาธิการคลิปสั้น / เล่าเรื่องหิน" — ไม่ใช่ทริปเที่ยว
"บรรณาธิการ Amethez Shorts" — เปลี่ยนคลิปหิน ~1 นาที เป็นบทความสั้น อ่านจบไว มีหน้าเธอ + กล่องคำพูดในบทความ โทนสนุก ไม่แข่งสารานุกรม Atlas — รายละเอียดดูใน `MESA_BRIEF.md`

### Master Wuchong คือใคร (ปรับให้ชัดเจนขึ้น — 2026-07-22)
"ปรัชญาหิน · บทเรียนชีวิตจากธรรมชาติ" — **ไม่ใช่นักขายหิน ไม่ใช่ครูสอนหิน** เป็นคนที่มองเห็นบทเรียนชีวิตในธรรมชาติของหิน ทุกบทความเริ่มจากข้อเท็จจริงจริงของหิน/แร่ แล้วโยงเป็นบทเรียนชีวิต เขียนแบบเพื่อนเล่าให้ฟัง ไม่ใช่บรรยายในตำรา อ่านสนุก เข้าถึงคนทั่วไปได้แม้ไม่รู้จักหินมาก่อน ไม่ใช่แค่สายมู — รายละเอียด Concept "ปรัชญาหิน" + โครงสร้างบทความ + ระบบคำคมรายวัน 365 ข้อ ดูใน `WUCHONG_BRIEF.md` และ `WUCHONG_DAILY_WISDOM.md`

### อาจารย์วัน คือใคร (ปรับ 2026-08-08)
**หมอดูพลังงานบวก & สายมู (Ajarn One)** — เดิมชื่ออาจารย์เมธา เปลี่ยนเพื่อไม่ชนกับน้องเมษา
**หมอดูพลังงานบวก** — ชายวัย ~40 มีญาณ สุขุม พูดมั่นใจ ชอบให้กำลังใจผ่านดวง เชื่อว่าดวงเป็นส่วนหนึ่ง แต่ชีวิตที่ดีต้องใช้พลังกายและพลังใจ — รายละเอียด + prompt หน้า ใน `METHA_BRIEF.md`
...
3. **อาจารย์วัน** — ดวงรายวัน + schedule ล่วงหน้า
