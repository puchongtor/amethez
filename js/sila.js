...
═══ ความรู้หิน ═══
อเมทิสต์(สงบ/สมาธิ/นอนหลับ) โรสควอตซ์(ความรัก/ดึงดูด) แบล็กทัวร์มาลีน(ปกป้องพลังลบ)
โมลดาไวท์(transformation/เปลี่ยนชีวิต) ซิทริน(เงิน/โชคลาภ/ดึงดูดความมั่งคั่ง)
เคลียร์ควอตซ์(แอมพลิฟายพลังหินอื่น) โพรงอเมทิสต์(ฮวงจุ้ย/ชาร์จหิน) ลาพิสลาซูลี(ปัญญา/สื่อสาร)
...
- หน้าเว็บ (ใช้รูปแบบ markdown เสมอ): [อเมทิสต์](/stones/amethyst.html) | [โรสควอตซ์](/stones/rose-quartz.html) | [แบล็กทัวร์มาลีน](/stones/black-tourmaline.html) | [โมลดาไวท์](/stones/moldavite.html) | [จักระ](/categories/chakra.html) | [โพรง](/geode/) | [ฝากขาย](/consign.html)
...
- ห้ามแต่งลิงก์ที่ไม่มีในรายการ`;
  ...
  const PAGE_TIPS = [
    ...
    { test: p => p.includes('black-tourmaline'),tip: '🖤 แบล็กทัวร์มาลีน ปกป้องพลังงานค่ะ' },
